...
%>
		...
		<form method="POST" id="review" action="register">
			...
			<div>
			<input type="text" class="form-control" name="name" value="<%=session.getAttribute("uname")%>"></br>
			<input type="email" class="form-control" name="email" value="<%=session.getAttribute("email")%>">
			</div></br>
			<textarea type="text" name="opinion" cols="30" rows="5" placeholder="Your opinion..." style="height: 180px; background-color: #f5f5f5; border: none;"></textarea>
			<div class="btn-group">
	...
	jQuery.validator.addMethod("checkemail", function (value, element) {
		...
		$("#review").validate({
			rules: {
				...
				opinion: {
				required: "Please give your opinion.",
				}
				}
				});
				});
