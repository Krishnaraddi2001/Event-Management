...
.banner {
	background: url(https://eventsstudio.in/wp-content/uploads/2023/03/w-event-slider-img-1-opt.jpg);
	height: 100vh;
...
<section class="banner fade">
    ...
    <script>
        ...
        function changeBg() {
        	...
        	const images = [
        			'url("https://eventsstudio.in/wp-content/uploads/2023/03/w-event-slider-img-3-opt.jpg")',
        			'url("https://eventsstudio.in/wp-content/uploads/2023/03/w-event-slider-img-1-opt.jpg")',
        			'url("https://eventsstudio.in/wp-content/uploads/2023/03/w-event-slider-img-2-opt.jpg")',
